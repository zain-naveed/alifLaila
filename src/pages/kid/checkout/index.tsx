      ...
      <div className={classNames(styles.topLevelContainer)} ref={bodyRef}>
        ...
        >
          ...
          {cart?.cart?.length > 0 ? (
            <div
              className={classNames(
                "d-flex align-items-start justify-content-between flex-column flex-md-row gap-5 gap-md-0"
              )}
            >
              <div className={classNames(styles.leftContainer)}>
                ...
                <div
                  className={classNames(
                    "px-3 py-4 d-flex align-items-center justify-content-end w-100"
                  )}
                >
                  <CustomButton
              ...
              <div className={classNames(styles.rightContainer, "px-4")}>
                {/* <div
                  className={classNames(
...
const OrderCard = ({ item }: any) => {
  ...
  return (
    <div
      ...
      style={showDetail ? { background: "#fafafb" } : {}}
    >
      <div
        className={classNames(
