      ...
      <div className={classNames(styles.topLevelContainer)} ref={bodyRef}>
        ...
        >
          <div
            className={classNames(
              "d-flex justify-content-start flex-column flex-md-row align-items-start gap-5 my-4"
            )}
          >
            ...
            <div className={styles.bookDetailItemContainer}>
              ...
              >
                ...
                >
                  ...
                  >
                    <BookIcon2
                      className={classNames(styles.bookIcon, "mt-1")}
                    />
        ...
        >
          ...
          >
            ...
            <div
              className={classNames(
                "d-flex flex-column flex-sm-row align-items-center justify-content-start gap-4 py-3",
            ...
            >
              ...
              >
                ...
                <div
                  className={classNames(
                    "d-flex align-items-center justify-content-end gap-1 position-relative"
                  )}
                  role="button"
                  onClick={() => {
                ...
                >
                  <label
                    className={classNames(styles.totalRatings)}
                    role="button"
                  >
                    {activeFilter?.label}
                  </label>
        ...
        <div
          className={classNames(
            ...
            "px-3 px-sm-0 mb-2 mt-4 w-100"
          )}
        >
          <label className={classNames(styles.bookSuggestedHeading, "mt-3")}>
