...
import { isAlphaNumericCheck } from "shared/utils/helper";
import { ParentRegisterVS } from "shared/utils/validations";
...
const RegisterParent = ({ handleClose }: LoginModalProps) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: ParentRegisterVS,
